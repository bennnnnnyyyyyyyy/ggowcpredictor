...
- **Responsive UI**: Header controls, filters, match cards, leaderboard/group tables, third-place table, bracket, and homepage dashboard now reflow more cleanly on phones
